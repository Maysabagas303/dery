            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="simpan_petugas.php">
                    <div class="form-group">
                      <input type="text" name="id_petugas" class="form-control form-control-user"  placeholder="Masukkan Id petugas">
                    </div>
                    <div class="form-group">
                      <input type="text" name="nama" class="form-control form-control-user"  placeholder="Masukkan Nama Petugas">
                    </div>
                  ...
                  <div class="text-center">
                    Sudah Punya Akun?<br>
                    <a class="small" href="index2.php">Silahkan Login!</a>
                  </div>
